...
public class MockMailService : IMailService
{
    ...
    private void InitializeMockMessages()
    {
        _messages.Add(new EmailMessage
        {
            ...
            To = new List<string> { "you@company.com" },
        ...
        _messages.Add(new EmailMessage
        {
            ...
            To = new List<string> { "you@company.com", "team@company.com" },
        ...
        _messages.Add(new EmailMessage
        {
            ...
            To = new List<string> { "you@company.com" },
            Cc = new List<string> { "accounting@company.com" },
        ...
        _messages.Add(new EmailMessage
        {
            ...
            To = new List<string> { "everyone@company.com" },
