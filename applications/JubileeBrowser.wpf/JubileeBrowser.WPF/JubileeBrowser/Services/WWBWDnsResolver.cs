...
public class WWBWDnsResolver
{
    ...
    private static readonly Dictionary<string, (string PublicUrl, string? ThirdPartyOverride)> FallbackMappings = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        { "inspire://jubilee.inspire", ("https://www.worldwidebibleweb.com/inspire/jubilee/", "https://www.jubileeinspire.com") },
        ...
        { "inspire://jubilee.insp", ("https://www.worldwidebibleweb.com/inspire/jubilee/", "https://www.jubileeinspire.com") },
