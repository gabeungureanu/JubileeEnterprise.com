/**
 * Zero-Downtime Reload Trigger
 *
 * TEMPLATE FILE - Copy to your application.
 *
...
console.log('Zero-Downtime Reload');
console.log('====================');
console.log('');
...
if (!fs.existsSync(pidFile)) {
  ...
  console.error('');
  console.error('Check with: sc query "yourservicename.exe"');
  process.exit(1);
}
...
try {
  ...
  console.error('The service may have stopped or restarted.');
  console.error('');
  console.error('Try restarting the service:');
  console.error('  sc stop "yourservicename.exe"');
  console.error('  sc start "yourservicename.exe"');
  process.exit(1);
}
...
console.log('  - daemon/*.out.log');
console.log('  - daemon/*.err.log');
