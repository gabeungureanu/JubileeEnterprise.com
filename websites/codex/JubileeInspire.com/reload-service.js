/**
 * JubileeInspire.com - Zero-Downtime Reload Trigger
 *
...
console.log('Zero-Downtime Reload - JubileeInspire.com');
console.log('=========================================');
console.log('');
...
if (!fs.existsSync(pidFile)) {
  ...
  console.error('');
  console.error('Check with: sc query "jubileeinspire.exe"');
  process.exit(1);
}
