/**
 * Windows Service Installer for JubileeInspire.com
...
const svc = new Service({
  name: 'JubileeInspire',
  description: 'JubileeInspire.com Production Server (Clustered with Zero-Downtime Reload)',
...
svc.on('install', function() {
  console.log('JubileeInspire service installed successfully!');
  console.log('Starting service...');
  svc.start();
});

svc.on('start', function() {
  console.log('JubileeInspire service started!');
...
svc.on('alreadyinstalled', function() {
  console.log('JubileeInspire service is already installed.');
});
...
// Install the service
console.log('Installing JubileeInspire as a Windows Service (Clustered)...');
