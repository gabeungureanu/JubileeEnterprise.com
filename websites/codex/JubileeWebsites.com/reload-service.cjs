/**
 * Inspire Web Server (JubileeWebsites.com) - Zero-Downtime Reload Trigger
 *
...
console.log('Zero-Downtime Reload - Inspire Web Server');
console.log('=========================================');
console.log('');
...
if (!fs.existsSync(pidFile)) {
  ...
  console.error('');
  console.error('Check with: sc query "inspirewebserver.exe"');
  process.exit(1);
}
