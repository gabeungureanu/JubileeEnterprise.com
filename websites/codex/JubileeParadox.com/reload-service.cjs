/**
 * JubileeParadox.com - Zero-Downtime Reload Trigger
 *
...
console.log('Zero-Downtime Reload - JubileeParadox.com');
console.log('=========================================');
console.log('');
...
if (!fs.existsSync(pidFile)) {
  ...
  console.error('');
  console.error('Check with: sc query "jubileeparadox.exe"');
  process.exit(1);
}
